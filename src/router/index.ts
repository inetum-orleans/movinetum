...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'Films',
    props: (route) => ({
      page: parseInt(route.params.page as string),// On passe le numéro de la page au composant en tant que nombre.
    }),
  ...
  },
  {
    ...
    name: 'DetailFilm',
    props: (route) => ({
      id: parseInt(route.params.id as string),// On passe l'identifiant du film au composant en tant que nombre.
    }),
  ...
  },
  {
    ...
    props: (route) => ({
      page: parseInt(route.params.page as string),// On passe le numéro de la page au composant en tant que nombre.
      recherche: route.query.recherche,// On passe la recherche.
    }),
    name: 'Recherche',
